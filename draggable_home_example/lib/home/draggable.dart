...
class _DraggableHomeState extends State<DraggableHome> {
          ...
          StreamBuilder<List<bool>>(
            ...
            builder: (BuildContext context, AsyncSnapshot<List<bool>> snapshot) {
              ...
              return SliverAppBar(
                ...
                expandedHeight: streams[1] ? fullyExpandedHeight : (expandedHeight - 1.9),
                flexibleSpace: Stack(
                  children: [
                    FlexibleSpaceBar(
                      background:
                          Container(child: streams[1] ? (widget.expandedBody ?? Container()) : widget.headerWidget),
                    ),
                    Positioned(
  ...
  Widget sliverList(BuildContext context, double topHeight) {
